 ...
 */
export const ToolConfiguration = pipe(S.struct({
    application_type: S.literal("web"),
    grant_types: S.union(S.tuple(S.literal("client_credentials"), S.literal("implicit")), S.tuple(S.literal("implicit"), S.literal("client_credentials"))),
    ...
    scope: Scopes,
}), S.extend(I18nKey("client_name")), S.extend(I18nKey("client_uri")), S.extend(I18nKey("tos_uri")), S.extend(I18nKey("policy_uri")));
